...
$php_file_name = "airline_document_sy";


function cs_airline_document_sy()
{
    ...
    $mainrepeater = 'airline_booking_confirmation';
    $repeaterfield = 'airline_booking_confirmation_document';
