  ...
  <section id="three_ContactInfo" class="hidden">
    ...
    <div class="cs-container">
      ...
      <div class="bs-heading mb-4">
        ...
        <p>
          Please provide your details below so we can process your Seychelles Medical Protection application accurately
          and securely.
        </p>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <input type="tel" id="input_ContactYourNumber" class="form-control d-block" placeholder="Enter phone number"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="mb-3">
                ...
                <input type="text" onchange="_swiftFV.handle_emgTelephone(this)"
                  class="form-control d-block datepickerDOB" data-datepicker="true" placeholder="Date Of Birth" name="emg_contact_dob">
              </div>
            </div>
          </div>
      ...
      <div id="btn_AddContact" class="mt-2">
        <!-- <a class="fw-bold" style="text-decoration: underline;" href="#">+ Add More -->
        <a class="bs-link" href="#">+ Add More
          Applicants
        </a>
      </div>
