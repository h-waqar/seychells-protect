    ...
    <section id="ten_PaymentOptions" class="hidden">
        <div class="cs-container">
            ...
            <div class="row payment-by-card" id="div_PayByCard">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_first_name" id="firstName" placeholder="First Name">
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_last_name" id="lastName" placeholder="Last Name">
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_postal_code" id="postalCode" placeholder="Postal Code">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_card_number" id="proceed_CardNumber" placeholder="Card Number">
                        ...
                        <div class="card-img-wrapper">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="512" height="512" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                                <g>
                                    <path d="M512 402.281c0 16.716-13.55 30.267-30.265 30.267H30.265C13.55 432.549 0 418.997 0 402.281V109.717c0-16.715 13.55-30.266 30.265-30.266h451.47c16.716 0 30.265 13.551 30.265 30.266v292.564z" style="" fill="#306fc5" data-original="#306fc5" class=""></path>
                                    <path d="M21.517 402.281V109.717c0-16.715 13.552-30.266 30.267-30.266h-21.52C13.55 79.451 0 93.001 0 109.717v292.565c0 16.716 13.55 30.267 30.265 30.267h21.52c-16.715 0-30.268-13.552-30.268-30.268z" style="opacity:0.15;enable-background:new ;" fill="#202121" data-original="#202121"></path>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_card_holder_name" id="proceed_CardHolderName" placeholder="Card Holder Name">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="proceed_card_cvv" id="proceed_CardCvv" placeholder="Card CVV No">
                    </div>
                </div>
            ...
            <div class="payment-by-giropay hidden" id="div_PayByGiro">
                ...
                <p>
                    <svg class="p-Icon p-Icon--redirectMobile Icon p-Icon--xl u-mr-3 me-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 40" role="presentation">
                        <path opacity=".6" fill-rule="evenodd" clip-rule="evenodd" d="M9 1a4 4 0 00-4 4v30a4 4 0 004 4h18a4 4 0 004-4v-9a1 1 0 10-2 0v9a2 2 0 01-2 2H9a2 2 0 01-2-2V14a2 2 0 012-2h18a2 2 0 012 2v2a1 1 0 102 0V5a4 4 0 00-4-4H9zm26.992 15.409L39.583 20H24a1 1 0 100 2h15.583l-3.591 3.591a1 1 0 101.415 1.416l5.3-5.3a1 1 0 000-1.414l-5.3-5.3a1 1 0 10-1.415 1.416zM7 8.5A1.5 1.5 0 018.5 7h19a1.5 1.5 0 010 3h-19A1.5 1.5 0 017 8.5zM23 3a1 1 0 100 2 1 1 0 000-2zm-8 1a1 1 0 011-1h4a1 1 0 110 2h-4a1 1 0 01-1-1zm0 30a1 1 0 100 2h6a1 1 0 100-2h-6z"></path>
                    </svg>
            ...
            <div class="payment-by-wechat hidden" id="div_PayByWeChat">
                ...
                <div class="mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 16" fill="none" role="presentation" focusable="false">
                        <g clip-path="url(#a)">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="m15.416 3.973-.015-.017C13.82 2.129 11.291 1 8.51 1 3.999 1 0 4.016 0 8.142c0 2.102 1.086 3.96 2.716 5.236l-.07.254a237.8 237.8 0 0 0-.175.664 1.602 1.602 0 0 0-.072.442v.002a1.24 1.24 0 0 0 1.933 1.045l1.522-.874a9.847 9.847 0 0 0 2.638.356c4.49 0 8.508-3.015 8.508-7.142v-.007a6.317 6.317 0 0 0-.829-3.083" fill="#fff" />
                            <path d="M6.458 10.223a.49.49 0 0 1-.226.051.492.492 0 0 1-.435-.256l-.034-.068-1.374-2.934a.213.213 0 0 1-.017-.103.23.23 0 0 1 .07-.17.24.24 0 0 1 .173-.068c.056 0 .111.019.157.05l1.616 1.127c.126.075.27.116.417.12.09-.001.178-.019.261-.052l7.58-3.31C13.27 3.024 11.028 2 8.508 2 4.355 2 1 4.747 1 8.142c0 1.842 1.008 3.514 2.59 4.64a.44.44 0 0 1 .174.547c-.122.46-.33 1.212-.33 1.245a.603.603 0 0 0-.035.188.23.23 0 0 0 .07.17.24.24 0 0 0 .173.068.2.2 0 0 0 .139-.051l1.634-.939a.838.838 0 0 1 .4-.12c.076.004.152.015.225.035a8.853 8.853 0 0 0 2.451.342c4.137 0 7.509-2.747 7.509-6.142a5.322 5.322 0 0 0-.852-2.849L6.51 10.189l-.052.034Z" fill="#1AAD19" />
                        </g>
                    </svg>
                </div>
